...
createList = ["CREATE TABLE IF NOT EXISTS Player (PlayerID int PRIMARY KEY, Handle char(30), Name char(30), Location char(30), PlayerNumber int, Role char(10), Picture char(100))",
              ...
              "CREATE TABLE IF NOT EXISTS Team (TeamID int PRIMARY KEY, Name char(30), Division char(30), Logo char(100))",
              "CREATE TABLE IF NOT EXISTS Match (MatchID int PRIMARY KEY, Time int, Score char(10), Winner int REFERENCES Team(TeamID))",
              ...
              "CREATE TABLE IF NOT EXISTS Hero (HeroID int PRIMARY KEY, Name char(30) UNIQUE)",
              "CREATE TABLE IF NOT EXISTS PlayedOn(Match int, MapNumber int, Hero int REFERENCES Hero(HeroID), Player int REFERENCES Player(PlayerID), Damage float, Deaths int, Eliminations int, Healing float, FOREIGN KEY(Match, MapNumber) REFERENCES MapInstance, PRIMARY KEY(Match, MapNumber, Hero, Player))",
